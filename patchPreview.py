...
file_path = 'frontend/src/app/admin/cv-import/page.tsx'
with open(file_path, 'r', encoding='utf-8') as f:
    content = f.read()

# Replace Experience
exp_start_str = '<div key={i} className="border-l-4 border-blue-500 pl-4 group">'
exp_end_str = '</div>\n              ))}'

exp_replace = """<div key={i} className="border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm mb-6 group">
...
start_idx = content.find(exp_start_str)
end_idx = content.find(exp_end_str, start_idx)
if start_idx != -1 and end_idx != -1:
    content = content[:start_idx] + exp_replace + content[end_idx:]

# Education
edu_start_str = '<div key={index} className="glass p-6 md:p-8 rounded-2xl transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_8px_30px_rgba(var(--color-primary-rgb),0.15)] hover:border-primary/30 bg-white/5 border border-gray-200 dark:border-gray-800 group">'
edu_end_str = '</div>\n                );\n              })}'

edu_replace = """<div key={index} className="border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm mb-6 group">
                    <div className="flex justify-between items-start gap-2 mb-4 border-b border-gray-100 dark:border-gray-700 pb-4">
                      <h3 className="text-xl font-semibold text-gray-900 dark:text-white">
...
start_idx = content.find(edu_start_str)
end_idx = content.find(edu_end_str, start_idx)
if start_idx != -1 and end_idx != -1:
    content = content[:start_idx] + edu_replace + content[end_idx:]

# Certifications
cert_start_str = '<div key={i} className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4 border border-purple-200 dark:border-purple-800 group">'
cert_end_str = '</div>\n              ))}'

cert_replace = """<div key={i} className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 mb-4 group shadow-sm">
                  <div className="flex justify-between items-start gap-2 mb-4 border-b border-gray-100 dark:border-gray-700 pb-4">
...
start_idx = content.find(cert_start_str)
end_idx = content.find(cert_end_str, start_idx)
if start_idx != -1 and end_idx != -1:
    content = content[:start_idx] + cert_replace + content[end_idx:]

# Achievements
ach_start_str = '<div key={i} className="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg p-4 border border-yellow-200 dark:border-yellow-800 group">'
ach_end_str = '</div>\n              ))}'

ach_replace = """<div key={i} className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 mb-4 group shadow-sm">
                  <div className="flex justify-between items-start gap-2 mb-4 border-b border-gray-100 dark:border-gray-700 pb-4">
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white">
                      {ach.title}
                    </h3>
...
start_idx = content.find(ach_start_str)
end_idx = content.find(ach_end_str, start_idx)
if start_idx != -1 and end_idx != -1:
    content = content[:start_idx] + ach_replace + content[end_idx:]

# Projects
proj_start_str = '<div key={i} className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 group">'
proj_end_str = '</div>\n              ))}'

proj_replace = """<div key={i} className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 mb-4 group shadow-sm">
                  <div className="flex justify-between items-start gap-2 mb-4 border-b border-gray-100 dark:border-gray-700 pb-4">
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white">
...
start_idx = content.find(proj_start_str)
end_idx = content.find(proj_end_str, start_idx)
if start_idx != -1 and end_idx != -1:
    content = content[:start_idx] + proj_replace + content[end_idx:]

# Testimonials
test_start_str = '<div key={i} className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 border-l-4 border-indigo-500 group relative">'
test_end_str = '</div>\n              ))}'

test_replace = """<div key={i} className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700 group relative shadow-sm mb-4">
                  <button
...
start_idx = content.find(test_start_str)
end_idx = content.find(test_end_str, start_idx)
if start_idx != -1 and end_idx != -1:
    content = content[:start_idx] + test_replace + content[end_idx:]
