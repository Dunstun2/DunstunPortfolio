...
export default function ProjectCaseStudyPage() {
  ...
  return (
    <div className="min-h-screen pb-24">
      {/* 1. Hero Section */}
      <section className="relative overflow-hidden bg-bg-light dark:bg-bg-dark pt-12 pb-16 border-b border-white/10">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {project.thumbnail_url && (
            <div className="rounded-3xl overflow-hidden shadow-2xl border border-white/10 mt-8 max-h-[500px] relative">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 space-y-16">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {project.problem && (
              <div className="glass p-8 rounded-3xl border border-red-500/20 relative overflow-hidden">
                ...
                <p className="text-text-light leading-relaxed whitespace-pre-line">{project.problem}</p>
              </div>
            )}
            {project.solution && (
              <div className="glass p-8 rounded-3xl border border-green-500/20 relative overflow-hidden">
                ...
                <p className="text-text-light leading-relaxed whitespace-pre-line">{project.solution}</p>
              </div>
            )}
          </section>
        )}
          ...
          <section>
            ...
            <div className="flex flex-wrap gap-3">
              {project.technologies.map((tech: string) => (
                <span key={tech} className="px-4 py-2 bg-secondary/10 text-secondary border border-secondary/30 rounded-xl font-semibold text-sm">
                  {tech}
                </span>
              ))}
            </div>
        ...
        <div className="text-center pt-8">
          <Link href="/projects" className="px-8 py-4 bg-transparent border-2 border-primary text-primary font-bold rounded-full hover:bg-primary hover:text-white transition-all hover:-translate-y-1 inline-flex items-center gap-2">
