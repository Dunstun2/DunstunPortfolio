...
import { useRefereePlacement } from '@/utils/useRefereePlacement';

export default function AboutPage() {
  const { isInlineEditing } = useInlineEdit();
  const showReferees = useRefereePlacement('about');
  ...
  useEffect(() => {
    Promise.all([
      ...
      fetchApi('/achievements/published?limit=4')
  ...
  // If corporate website mode, render corporate about section
  if (settings?.site_mode === 'corporate' || availableSections?.site_mode === 'corporate') {
    return (
      <div className="min-h-screen">
        <CorporateAbout variant="full" />
      </div>
    );
  }
    ...
    <div className="flex flex-col min-h-[calc(100vh-64px)] pb-8">
      ...
      <section className="relative z-20 w-full pt-8 md:pt-12 pb-4 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className={`relative ${expandIntro ? "" : "overflow-hidden max-h-[32rem] md:max-h-[28rem]"}`}>
            {(about.image_url || isInlineEditing) && (
                ...
                <div className="relative">
                  ...
                  <div className="relative w-52 h-52 md:w-64 md:h-64 lg:w-72 lg:h-72 rounded-full overflow-hidden border-4 border-primary/30 flex-shrink-0 shadow-[0_0_50px_rgba(var(--color-primary-rgb),0.3)]">
                    <InlineResourceImage
                      ...
                      currentSrc={about.image_url} alt={about.title || "Profile"}
            ...
            <div className="text-left">
              <h1 className="text-3xl md:text-4xl font-bold text-heading-light mb-4 tracking-tight leading-tight mt-2">
                <span className="text-primary">
                  <InlineResourceText resource="about" id="active" field="title" defaultValue={about.title} />
                </span>
              </h1>
              ...
              {about.personal_introduction && (
                <div className="mt-2">
                  <p className="text-text-light text-base md:text-lg leading-relaxed whitespace-pre-line">
                    <InlineResourceText resource="about" id="active" field="personal_introduction" multiline defaultValue={about.personal_introduction} />
                  </p>
                </div>
              )}
            </div>
      ...
      {about.professional_summary && (
        <section className="pt-4 pb-8 md:pb-12 max-w-7xl mx-auto px-0 sm:px-4 md:px-6 lg:px-8 w-full">
          <div className="glass p-5 md:p-12 rounded-none sm:rounded-3xl border-t-4 border-t-secondary relative overflow-hidden">
            ...
            <h2 className="text-3xl font-bold mb-8 relative z-10"><ColoredTitle settingKey="about_title_summary" title="Professional Summary" /></h2>
            ...
            <div className="relative z-10">
              <div className={`relative ${expandSummary ? "" : "overflow-hidden max-h-[18rem] md:max-h-[16rem]"}`}>
                <p className="text-text-light text-lg leading-relaxed whitespace-pre-line">
                  <InlineResourceText resource="about" id="active" field="professional_summary" multiline defaultValue={about.professional_summary} />
                </p>
            ...
            <div className="flex flex-col gap-6 text-left">
              {(about as any).vision_statement && (
                <div className="flex-1 border-l-4 border-secondary pl-6 md:pl-8">
                  <h2 className="text-sm tracking-widest uppercase font-bold mb-4"><ColoredTitle settingKey="about_title_vision" title="Vision Statement" /></h2>
                  <p className="text-xl md:text-2xl text-heading-light font-medium leading-relaxed">
                    <InlineResourceText resource="about" id="active" field="vision_statement" multiline defaultValue={(about as any).vision_statement} />
                  </p>
                </div>
              )}
              {about.mission_statement && (
                <div className="flex-1 border-l-4 border-primary pl-6 md:pl-8">
                  <h2 className="text-sm tracking-widest uppercase font-bold mb-4"><ColoredTitle settingKey="about_title_mission" title="Mission Statement" /></h2>
                  <p className="text-xl md:text-2xl text-heading-light font-medium leading-relaxed">
                    <InlineResourceText resource="about" id="active" field="mission_statement" multiline defaultValue={about.mission_statement} />
                  </p>
                </div>
              )}
            </div>
      ...
      {validValues.length > 0 && (
        <section className="py-8 md:py-12 max-w-7xl mx-auto px-0 sm:px-4 md:px-6 lg:px-8 w-full">
          <h2 className="text-3xl font-bold mb-6 md:mb-8 text-center"><ColoredTitle settingKey="about_title_values" title="My Values" /></h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {validValues.map((val: any) => (
              <div key={val.id} className="glass p-5 md:p-8 rounded-none sm:rounded-2xl hover:-translate-y-2 transition-transform duration-300 group">
                <h3 className="text-xl font-bold text-heading-light mb-4">
      ...
      {skillCategories.length > 0 && (
        <section className="py-8 md:py-12 bg-black/5 dark:bg-white/5">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold mb-6 md:mb-8 text-center"><ColoredTitle settingKey="about_title_skills" title="Skills & Expertise" /></h2>
                ...
                return (
                  <div key={`${category}-${idx}`} className="glass p-5 md:p-8 rounded-none sm:rounded-3xl border border-white/10 text-left">
                    ...
                    <div className="flex items-center justify-between mb-8 pb-4 border-b border-white/10">
                      <h3 className="text-2xl font-bold text-heading-light">
                        ...
                        <div key={skill.id} className="group">
                          <div className="flex justify-between items-center mb-2">
                            ...
                            <span className="text-sm font-bold text-primary">
                              <InlineResourceText resource="skills" id={skill.id} field="proficiency" defaultValue={String(skill.proficiency)} />%
                            </span>
                          </div>
                          ...
                          {(skill.description || isInlineEditing) && (
                            <p className="text-xs text-text-light/70 mt-2 leading-relaxed">
                              <InlineResourceText resource="skills" id={skill.id} field="description" multiline defaultValue={skill.description || ''} placeholder="Add description..." />
                            </p>
                          )}
                        </div>
                      ))}
        ...
        <section className="py-8 md:py-12 max-w-7xl mx-auto px-0 sm:px-4 md:px-6 lg:px-8 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            {validHighlights.length > 0 && (
              <div>
                <h2 className="text-3xl font-bold mb-6 md:mb-8"><ColoredTitle settingKey="about_title_milestones" title="Key Milestones" /></h2>
                    ...
                    <div key={item.id} className="relative pl-8 md:pl-12">
                      ...
                      <div className="flex flex-wrap items-baseline gap-x-3 mb-2">
                        <span className="text-primary font-bold tracking-widest text-sm">
                          <InlineResourceText resource="about/highlights" id={item.id} field="date" defaultValue={item.date} />
                        </span>
                        <h3 className="text-xl md:text-2xl font-bold text-heading-light">
                          <InlineResourceText resource="about/highlights" id={item.id} field="title" defaultValue={item.title} />
                        </h3>
                      </div>
                      <p className="text-text-light text-lg">
                        <InlineResourceText resource="about/highlights" id={item.id} field="description" multiline defaultValue={item.description} />
                      </p>
                    </div>
                  ))}
                </div>
            ...
            {validExplorations.length > 0 && (
              <div>
                <h2 className="text-3xl font-bold mb-6 md:mb-8"><ColoredTitle settingKey="about_title_exploring" title="Currently Exploring" /></h2>
                  ...
                  {validExplorations.map((exp: any) => (
                    <div key={exp.id} className="glass px-6 py-5 rounded-none sm:rounded-2xl flex flex-col gap-2 hover:border-primary/50 transition-colors w-full">
                      <span className="text-xs font-bold uppercase tracking-wider text-primary">
                        <InlineResourceText resource="about/explorations" id={exp.id} field="category" defaultValue={exp.category} />
                      </span>
                      <div className="flex items-center justify-between gap-4">
                        <span className="text-heading-light font-medium text-lg flex-1">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              {achievements.length > 0 && (
                <div>
                  <h2 className="text-3xl font-bold mb-6 md:mb-8"><ColoredTitle settingKey="about_title_awards" title="Awards & Recognition" /></h2>
                  <div className="flex flex-col gap-4">
                    {achievements.map((ach: any) => (
                      <div key={ach.id} className="glass p-5 rounded-xl border-l-4 border-l-secondary">
                        <h3 className="font-bold text-heading-light">
                          <InlineResourceText resource="achievements" id={ach.id} field="title" defaultValue={ach.title} />
                        </h3>
                        {(ach.issuer || isInlineEditing) && (
                          <p className="text-text-light text-sm mt-1">
                            <InlineResourceText resource="achievements" id={ach.id} field="issuer" defaultValue={ach.issuer || ''} placeholder="Issuer" />
                          </p>
                        )}
                      </div>
                    ))}
              ...
              {/* Interests */}
              {(validInterests.length > 0 || isInlineEditing) && (
                <div>
                  <h2 className="text-3xl font-bold mb-6 md:mb-8"><ColoredTitle settingKey="about_title_interests" title="Personal Interests" /></h2>
                  <div className="flex flex-wrap gap-3">
                    <InlineEditableList
                      resource="about"
                      id="active"
                      field="interests"
                      items={validInterests}
      ...
      {validStatistics.length > 0 && (
        <section className="py-8 md:py-12 max-w-7xl mx-auto px-0 sm:px-4 md:px-6 lg:px-8 w-full">
          <h2 className="text-3xl font-bold mb-6 md:mb-8 text-center"><ColoredTitle settingKey="about_title_stats" title="Impact in Numbers" /></h2>
      ...
      <section id="explore-more" className="py-8 md:py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <h2 className="text-3xl font-bold mb-6 md:mb-8 text-center"><ColoredTitle settingKey="about_title_explore" title="Explore More" /></h2>
      ...
      {/* Referees Section — shown when enabled in Admin → Referees → Section Placement */}
      {showReferees && <PortfolioReferees />}
