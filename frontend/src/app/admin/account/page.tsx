              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-2 pr-10 focus:outline-none focus:border-primary"
                  />
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    minLength={6}
                  />
                  <EyeIcon show={showAdminPw} onToggle={() => setShowAdminPw(!showAdminPw)} />
                </div>
              </div>
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-2.5 pr-10 focus:outline-none focus:border-red-500"
                  autoFocus
                />
                <EyeIcon show={showDeletePw} onToggle={() => setShowDeletePw(!showDeletePw)} />
              </div>
              {deleteError && (
