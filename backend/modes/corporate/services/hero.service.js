...
class HeroService {
   ...
   * If a corporate hero already exists, update the existing one.
   */
  async createOrUpdate(data) {
    ...
    if (existing) {
      // Update and publish the existing corporate hero
    ...
    // No corporate hero exists yet — create one and publish it immediately
